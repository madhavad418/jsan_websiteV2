...
export const newsArticles: NewsArticle[] = [
  ...
  },
  {
    ...
    featured: true,
    body: [
      'JSAN today unveiled the modernization of its Vehicle Tracking System (VTS), introducing AI-powered route optimization, predictive maintenance signals and real-time fleet analytics.',
