...
const techData: TechData[] = [
  ...
  },
  {
    ...
    stats: [
      ...
      { value: 'OAuth 2.0', label: 'Secure by Design' },
    ],
  ...
  },
  {
    ...
    stats: [
      ...
      { value: 'Real-Time', label: 'Dashboards & Insights' },
    ],
    whyTitle: 'From Raw Data to Strategic Advantage.',
    whyDescription: 'Data is only valuable when it drives action. Our analytics solutions combine data engineering, business intelligence, and advanced analytics to help organizations make faster, smarter decisions.',
    benefits: [
      ...
      'Shorter time from raw data to insight',
    ],
    services: [
  ...
  },
  {
    ...
    heroDescription: 'Leverage the power of cloud computing with our AWS, Azure, and Google Cloud expertise. From migration to optimization, we help you build a cloud-native future.',
    ...
    services: [
      ...
      { title: 'Cost Optimization', description: 'Right-sizing, reserved instances, spot strategies, and FinOps practices to reduce your cloud spend.', icon: DollarSign },
  ...
  },
  {
    ...
    whyDescription: 'With evolving cyber threats and regulatory demands, organizations need proactive security strategies. We protect your data, systems, and reputation with defence-in-depth approaches.',
    benefits: [
  ...
  },
  {
    ...
    stats: [
      ...
      { value: 'Cloud-Native', label: 'Warehouse Design' },
    ],
  ...
  },
  {
    ...
    stats: [
      ...
      { value: 'IaC', label: 'Reproducible Environments' },
    ],
  ...
  },
  {
    ...
    stats: [
      ...
      { value: 'RPA + AI', label: 'Intelligent Automation' },
    ],
  ...
  },
  {
    ...
    stats: [
      ...
      { value: 'Proactive', label: 'Monitoring & Alerting' },
    ],
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-gray-600 text-lg mb-10">
            Partner with JSAN Consulting to leverage {tech.title.toLowerCase()} for your organization's growth and efficiency.
          </p>
